...
pub async fn append_part(
    ...
    patch_upload_multipart_upload_part: models::PatchUploadMultipartUploadPart,
...
pub async fn check_version_setting(
    configuration: &configuration::Configuration,
    head_bucket_request: models::HeadBucketRequest,
...
pub async fn complete_create_bucket(
    configuration: &configuration::Configuration,
    create_bucket_is_completed: models::CreateBucketIsCompleted,
...
pub async fn complete_delete_bucket(
    configuration: &configuration::Configuration,
    delete_bucket_is_completed: models::DeleteBucketIsCompleted,
...
pub async fn complete_delete_objects(
    configuration: &configuration::Configuration,
    delete_objects_is_completed: models::DeleteObjectsIsCompleted,
...
pub async fn complete_upload(
    configuration: &configuration::Configuration,
    patch_upload_is_completed: models::PatchUploadIsCompleted,
...
pub async fn continue_upload(
    configuration: &configuration::Configuration,
    continue_upload_request: models::ContinueUploadRequest,
) -> Result<Vec<models::ContinueUploadResponse>, Error<ContinueUploadError>> {
    let local_var_configuration = configuration;
...
pub async fn head_object(
    configuration: &configuration::Configuration,
    head_object_request: models::HeadObjectRequest,
) -> Result<models::HeadObjectResponse, Error<HeadObjectError>> {
    let local_var_configuration = configuration;
...
pub async fn healthz(
    configuration: &configuration::Configuration,
) -> Result<models::HealthcheckResponse, Error<HealthzError>> {
    let local_var_configuration = configuration;
...
pub async fn list_buckets(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::BucketResponse>, Error<ListBucketsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_multipart_uploads(
    configuration: &configuration::Configuration,
    list_object_request: models::ListObjectRequest,
) -> Result<Vec<models::MultipartResponse>, Error<ListMultipartUploadsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_objects(
    configuration: &configuration::Configuration,
    list_object_request: models::ListObjectRequest,
) -> Result<Vec<models::ObjectResponse>, Error<ListObjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_objects_versioning(
    configuration: &configuration::Configuration,
    list_object_request: models::ListObjectRequest,
) -> Result<Vec<models::ObjectResponse>, Error<ListObjectsVersioningError>> {
    let local_var_configuration = configuration;
...
pub async fn list_parts(
    configuration: &configuration::Configuration,
    list_parts_request: models::ListPartsRequest,
) -> Result<Vec<models::LogicalPartResponse>, Error<ListPartsError>> {
    let local_var_configuration = configuration;
...
pub async fn locate_bucket(
    configuration: &configuration::Configuration,
    locate_bucket_request: models::LocateBucketRequest,
) -> Result<models::LocateBucketResponse, Error<LocateBucketError>> {
    let local_var_configuration = configuration;
...
pub async fn locate_bucket_status(
    configuration: &configuration::Configuration,
    locate_bucket_request: models::LocateBucketRequest,
) -> Result<models::BucketStatus, Error<LocateBucketStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LocateBucketStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn locate_object(
    configuration: &configuration::Configuration,
    locate_object_request: models::LocateObjectRequest,
) -> Result<models::LocateObjectResponse, Error<LocateObjectError>> {
    let local_var_configuration = configuration;
...
pub async fn locate_object_status(
    configuration: &configuration::Configuration,
    locate_object_request: models::LocateObjectRequest,
) -> Result<Vec<models::ObjectStatus>, Error<LocateObjectStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn put_bucket_versioning(
    configuration: &configuration::Configuration,
    put_bucket_versioning_request: models::PutBucketVersioningRequest,
) -> Result<Vec<models::LocateBucketResponse>, Error<PutBucketVersioningError>> {
    let local_var_configuration = configuration;
...
pub async fn register_buckets(
    configuration: &configuration::Configuration,
    register_bucket_request: models::RegisterBucketRequest,
...
pub async fn set_multipart_id(
    configuration: &configuration::Configuration,
    patch_upload_multipart_upload_id: models::PatchUploadMultipartUploadId,
...
pub async fn start_create_bucket(
    configuration: &configuration::Configuration,
    create_bucket_request: models::CreateBucketRequest,
) -> Result<models::CreateBucketResponse, Error<StartCreateBucketError>> {
    let local_var_configuration = configuration;
...
pub async fn start_delete_bucket(
    configuration: &configuration::Configuration,
    delete_bucket_request: models::DeleteBucketRequest,
) -> Result<models::DeleteBucketResponse, Error<StartDeleteBucketError>> {
    let local_var_configuration = configuration;
...
pub async fn start_delete_objects(
    configuration: &configuration::Configuration,
    delete_objects_request: models::DeleteObjectsRequest,
) -> Result<models::DeleteObjectsResponse, Error<StartDeleteObjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn start_upload(
    configuration: &configuration::Configuration,
    start_upload_request: models::StartUploadRequest,
) -> Result<models::StartUploadResponse, Error<StartUploadError>> {
    let local_var_configuration = configuration;
...
pub async fn start_warmup(
    configuration: &configuration::Configuration,
    start_warmup_request: models::StartWarmupRequest,
) -> Result<models::StartWarmupResponse, Error<StartWarmupError>> {
    let local_var_configuration = configuration;
...
pub async fn update_metrics(
...
) -> Result<serde_json::Value, Error<UpdateMetricsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateMetricsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_policy(
    configuration: &configuration::Configuration,
    set_policy_request: models::SetPolicyRequest,
) -> Result<serde_json::Value, Error<UpdatePolicyError>> {
    let local_var_configuration = configuration;
